...
lib LibSDL2
  ...
  fun compose_custom_blend_mode = SDL_ComposeCustomBlendMode(srcColorFactor : BlendFactor, dstColorFactor : BlendFactor, colorOperation : BlendOperation, srcAlphaFactor : BlendFactor, dstAlphaFactor : BlendFactor, alphaOperation : BlendOperation) : BlendMode
  ...
  fun render_set_clip_rect = SDL_RenderSetClipRect(renderer : Pointer(Renderer), rect : Pointet(Rect)) : Int32
